...
<section class="project-clean-split">
  ...
  <div class="project-media">
    ...
    <video id="projectVideo" muted loop playsinline preload="metadata">
      <source src="video/video_ordenes.mp4" type="video/mp4">
  ...
  <div class="project-info">
    ...
    <h1>Sitio Web gestión de órdenes</h1>

    <p>
      Un sistema para gestionar órdenes de reparación, usuarios y sucursales.
    </p>

    <ul class="tech-list">
      <li><strong>PHP:</strong> Backend y lógica de negocio.</li>
      <li><strong>JavaScript:</strong> Interactividad dinámica.</li>
      <li><strong>HTML & CSS:</strong> UI estructurada y responsiva.</li>
    </ul>
